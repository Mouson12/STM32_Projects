...
#define LCD_RST_0       HAL_GPIO_WritePin(GPIOC, LCD_RST_Pin, GPIO_PIN_RESET);
#define LCD_RST_1       HAL_GPIO_WritePin(GPIOC, LCD_RST_Pin, GPIO_PIN_SET);

#define LCD_DC_0        HAL_GPIO_WritePin(GPIOC, LCD_DC_Pin, GPIO_PIN_RESET);
#define LCD_DC_1        HAL_GPIO_WritePin(GPIOC, LCD_DC_Pin, GPIO_PIN_SET);
